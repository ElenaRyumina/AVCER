...
parser.add_argument(
    "--path_video", type=str, default="video/", help="Path to all videos"
)
parser.add_argument(
    "--path_report", type=str, default="report/", help="Path to save the report"
)
parser.add_argument(
    "--path_save_video",
    type=str,
    default="result_videos/",
    help="Path to save the result videos",
)
parser.add_argument(
    "--conf_d",
    type=float,
    default=0.7,
    help="Elimination threshold for false face areas",
)
...
def pred_all_video():
    ...
    for id, cr_path in enumerate(path_all_videos):
        ...
        detect = get_visualization.VideoCamera(
            path_video=os.path.join(args.path_video, cr_path),
        ...
        print(
            "Ressult saved in: ",
            os.path.join(args.path_save_video, name_video[:-4] + ".mp4"),
        )
