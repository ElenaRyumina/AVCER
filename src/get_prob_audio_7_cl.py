...
from architectures.audio_7_cl import ExprModelV1, ExprModelV2, ExprModelV3
...
def preprocess_audio_and_predict(
    ...
    save_path = os.path.join(save_path, "audio_{}_{}/".format(padding, step))
    ...
    pred = audio_ER.predict_emotion(path_video, fps)
        ...
        for step in [0.5]:
            ...
            for model_params in parameters:
                ...
                for name_video in tqdm(path_videos):
                    ...
                    audio_ER.predict_emotion(name_video, fps)
